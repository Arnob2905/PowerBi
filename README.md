Data Leverager – Power Query Transformation Project Overview
...
A fully automated and refresh-ready ETL pipeline. All transformations are managed inside Power Query to simulate data engineering workflows.
